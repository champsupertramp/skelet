...
$options[]      = array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'title'   => 'Number',
      'default' => '10',
      'after'   => ' <i class="sk-text-muted">$ (dollars)</i>',
    ),
    ...
    array(
      ...
      'options'   => array(
        ...
        'value-3' => 'http://placehold.it/100x80/ffbc00/',
        'value-4' => 'http://placehold.it/100x80/3498db/',
        'value-5' => 'http://placehold.it/100x80/555555/',
      ),
    ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => ' <i class="sk-text-muted">( this option is optional )</i>',
        ),
        ...
        array(
          ...
          'before' => '<i class="sk-text-muted">( important )</i> ',
        ),
        ...
        array(
          ...
          'after' => '<p class="sk-text-info">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="sk-text-muted">There is custom css <strong>style="width: 175px; height: 40px; border-color: #93C054;"</strong></p>',
        ),
        ...
        array(
          ...
          'after'      => '<p class="sk-text-muted">There is custom css <strong>style="width: 100%;"</strong></p>'
        ),
        ...
        array(
          ...
          'after'  => '<p class="sk-text-muted">This Text Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => '<p class="sk-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'before' => '<p class="sk-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="sk-text-muted">custom textarea attribute rows=10</p> ',
        ),
        ...
        array(
          ...
          'after'  => '<p class="sk-text-muted">This Textarea Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'         => '<p class="sk-text-muted"><strong>query_args:</strong> sort_order=desc, sort_column=post_title</p>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="sk-text-muted"><strong>query_args:</strong> post_type=your_post_type_name</div>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="sk-text-muted"><strong>query_args:</strong> post_type=your_post_type_name, taxonomy=your_taxonomy_name</div>',
        ),
        ...
        array(
          ...
          'after'        => '<div class="sk-text-muted"><strong>query_args:</strong> taxonomies=your_taxonomy_name, order=asc, orderby=name</div>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<div class="sk-text-muted">Reference site about Lorem Ipsum, a random Lipsum generator.</div>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="sk-text-muted">Lets write some description for this icon field.</i>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<p class="sk-text-muted">You can use default value <strong>get_template_directory_uri()</strong>."/images/screenshot-1.png"</p>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'options'      => array(
            'value-1'    => 'http://placehold.it/150x125/2ecc71',
            'value-2'    => 'http://placehold.it/150x125/e74c3c',
            'value-3'    => 'http://placehold.it/150x125/ffbc00',
            'value-4'    => 'http://placehold.it/150x125/3498db',
          ),
        ),
        ...
        array(
          ...
          'options'      => array(
            'value-1'    => 'http://placehold.it/150x125/ffbc00',
            'value-2'    => 'http://placehold.it/150x125/3498db',
            'value-3'    => 'http://placehold.it/150x125/e74c3c',
            'value-4'    => 'http://placehold.it/150x125/2ecc71',
            'value-5'    => 'http://placehold.it/150x125/555555',
          ),
          'default'      => 'value-2'
        ),
        ...
        array(
          ...
          'title'        => 'Image Select (Radio) with Default',
          'options'      => array(
            'value-1'    => 'http://placehold.it/80x80/2c3e50/',
            'value-2'    => 'http://placehold.it/80x80/2c3e50/',
            'value-3'    => 'http://placehold.it/80x80/2c3e50/',
            'value-4'    => 'http://placehold.it/80x80/2c3e50/',
            'value-5'    => 'http://placehold.it/80x80/2c3e50/',
            'value-6'    => 'http://placehold.it/80x80/2c3e50/',
            'value-7'    => 'http://placehold.it/80x80/2c3e50/',
            'value-8'    => 'http://placehold.it/80x80/2c3e50/',
          ),
          'radio'        => true,
          'default'      => 'value-2'
        ),
        ...
        array(
          ...
          'options'      => array(
            'value-1'    => 'http://placehold.it/80x80/2c3e50/',
            'value-2'    => 'http://placehold.it/80x80/2c3e50/',
            'value-3'    => 'http://placehold.it/80x80/e74c3c/',
            'value-4'    => 'http://placehold.it/80x80/ffbc00/',
            'value-5'    => 'http://placehold.it/80x80/3498db/',
            'value-6'    => 'http://placehold.it/80x80/2ecc71/',
            'value-7'    => 'http://placehold.it/80x80/2c3e50/',
            'value-8'    => 'http://placehold.it/80x80/2c3e50/',
          ),
          'multi_select' => true,
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="sk-text-warning">This field using debug=true</p>',
          'debug'   => true,
        ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'type'     => 'text',
      'title'    => 'Requried Text',
      'after'    => ' <small class="sk-text-warning">( * required )</small>',
      'default'  => 'lorem ipsum',
      'validate' => 'required',
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Also you can add your own validate from <strong>themename/sk-framework/functions/validate.php</strong>',
    ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'after'    => '<p class="sk-text-muted">This text field sanitized already, without any settings. we are using wordpress core.<br /> for eg. try too add <strong>&lt;p></strong> html tag</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="sk-text-muted">Disabled sanitize for this field (sanitize=false). try too add <strong>&lt;p></strong> html tag so, you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      ...
      'after'    => '<p class="sk-text-muted">This textarea field sanitized already, without any settings. we are using wordpress core.<br /> just allowing this tags wp core $allowedposttags</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="sk-text-muted">Disabled sanitize for this field (sanitize=false). you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Custom Sanitize, Also you can add your own validate from <strong>themename/sk-framework/functions/sanitize.php</strong>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="sk-text-muted">This text field sanitized as slug title (sanitize="title")</p>',
      'sanitize' => 'title',
    ),
...
$options[]           = array(
  ...
  'fields'           => array(
    ...
    array(
      ...
      'options'      => array(
        'green'      => 'http://placehold.it/100x80/2ecc71/',
        'red'        => 'http://placehold.it/100x80/e74c3c/',
        'yellow'     => 'http://placehold.it/100x80/ffbc00/',
        'blue'       => 'http://placehold.it/100x80/3498db/',
        'gray'       => 'http://placehold.it/100x80/555555/',
      ),
    ...
    array(
      ...
      'dependency'   => array( 'pabp_dep_10|pabp_dep_11|pabp_dep_12', '==|==|==', 'hello|world|true' ),
    ),
    // ------------------------------------
    ...
    array(
      ...
      'dependency'   => array( 'pabp_dep_13|pabp_dep_14', 'any|==', 'black,white|middle' ),
    ),
    ...
    array(
      ...
      'dependency'   => array( 'pabp_dep_15', '==', 'world' ),
    ),
    // ------------------------------------
