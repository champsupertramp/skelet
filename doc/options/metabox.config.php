...
$options[]    = sk_apply_prefix(array(
  ...
  'title'     => 'Skelet Custom Page Options',
  'post_type' => 'page',
  'context'   => 'normal',
  'priority'  => 'default',
  'sections'  => array(
    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'type'      => 'image_select',
          'options'   => array(
            'value-1' => 'http://placehold.it/65x65/2ecc71/',
            'value-2' => 'http://placehold.it/65x65/e74c3c/',
            'value-3' => 'http://placehold.it/65x65/3498db/',
          ),
          'default'   => 'value-2',
        ),
...
$options[]    = sk_apply_prefix(array(
  ...
  'title'     => 'Skelet Custom Post Options',
  'post_type' => 'post',
  'context'   => 'normal',
  'priority'  => 'default',
  'sections'  => array(
